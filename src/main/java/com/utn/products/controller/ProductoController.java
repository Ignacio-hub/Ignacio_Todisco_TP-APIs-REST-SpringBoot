...
@Tag(name = "Gestion de Productos en linea")
public class ProductoController {
    ...
    @Operation(summary = "Lista de los productos existentes.")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Producto inexistente")
    })
    @GetMapping("/{id}")
    ...
    @Operation(summary = "Obtener productos por la categoría")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista encontrada"),
            @ApiResponse(responseCode = "400", description = "No se encontro producto en la categoría ingresada")
    })
    ...
    @Operation(summary = "Actualizar productos por su ID")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Actualizar stock de los productos por su ID")
    @ApiResponses(value = {
